...
options.add_options()
    ...
    ("destination-filename,o", po::value<string>(&dst_filename), "destination filename [default is empty]")
    ("use-log,l", po::bool_switch(&use_log), "use log [default is false]")
    ("interpolation,t", po::value<string>(&interpolation_string), "interpolation (nearest|bilinear) [default is nearest]")
    ("border-mode,m", po::value<string>(&border_mode_string), "border mode (constant|replicate) [default is constant]")
  ...
  string window_name = "Polar Transform";
